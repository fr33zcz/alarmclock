...
public class Mp3Player {
	/**
	 * Canonical file path pointing to MP3 which is played when alarm has been invoked
	 */
	...
	/**
	 * True when the player is playing a song
	 */
	...
	/**
	 * Set the canonical path of MP3 to play when alarm is invoked
	 * 
	...
	/**
	 * Add playback listener with playbackStarted and playbackFinished methods
	 * 
	 * @param listener
	 */
	...
	/**
	 * Play the MP3 file previously set by setFileToPlay()
	 * 
	...
	/**
	 * Stop the current instance of MP3 player and close the player  
	 */
	public void stop() {
		if (player == null) {
