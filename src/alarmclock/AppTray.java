...
public class AppTray {
	...
	AppTray(final AlarmClock alarmClock, Display display, final Shell shell, final Settings settings) {
		...
		if (tray == null) {
			System.out.println ("System tray is unavailable");
		} else {
			...
			/**
			 * addListener instead of addSelectoinListener to handle right mouse-button
			 */
	...
	/**
	 * Returns instance of Tray
	 * 
	 * @return instance of current tray or null
	 */
	public Tray getTray() {
		return tray;
	}
