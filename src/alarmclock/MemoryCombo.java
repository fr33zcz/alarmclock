...
public class MemoryCombo {
	...
	/**
	 * Name of the file to store a list of recently played MP3s to
	 */
	private String mruFile = "mru.xml";
	
	/**
	 * Creates new SWT.Combo with memory for maxSize items
	 * 
	 * @param parent
	 * @param style
	 */
	...
	/**
	 * Stores a value to the list and reflects the change to combo
	 * 
	 * @param value
	 */
	...
	/**
	 * Removes all values from the list, stores new ones there, and reflectc the changes to combo
	 * 
	 * @param values
	 */
	...
	/**
	 * Sets number of maximum values to keep on the list
	 *  
	 * @param maxSize
	 */
	...
	/**
	 * Returns number of maximum values to keep on the list
	 * 
	 * @return maxSize
	 */
	...
	/**
	 * Disposes all operating system resources allocated for combo
	 */
	public void dispose() {
		combo.dispose();
	}
	...
	/**
	 * Sets filename to store the list in
	 * 
	 * @param filename
	 */
	...
	/**
	 * Gets filename to store the list in
	 * 
	 * @return filename
	 */
	...
	/**
	 * Loads data from a file to the list and reflects changes to combo
	 * 
	 * @param filename
	 */
